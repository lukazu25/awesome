...
-- Volume control with notify-send notifications
globalkeys = gears.table.join(globalkeys,
    awful.key({ }, "XF86AudioRaiseVolume", function ()
        ...
        awful.spawn.easy_async("pactl get-sink-volume @DEFAULT_SINK@", function(stdout)
            ...
            awful.spawn(string.format("notify-send 'Volume' '%s%%'", volume))
        end)
    ...
    awful.key({ }, "XF86AudioMute", function ()
        ...
        awful.spawn.easy_async("pactl get-sink-mute @DEFAULT_SINK@", function(stdout)
            ...
            awful.spawn(string.format("notify-send 'Volume' 'Mute: %s'", mute))
        end)
    end, {description = "toggle mute", group = "media"}),

    -- Brightness control with notify-send notifications
    awful.key({ }, "XF86MonBrightnessUp", function ()
        ...
        awful.spawn.easy_async("brightnessctl -m", function(stdout)
            ...
            awful.spawn(string.format("notify-send 'Brightness' '%s%%'", brightness))
        end)
...
awful.spawn.with_shell("setxkbmap -layout us,ge,ru -option grp:alt_shift_toggle")
